#
#  Be sure to run `pod spec lint HHZBaseClass.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "陈哲是个好孩子-基类"

  s.homepage     = "https://github.com/chenzhe555/HHZBaseClass"
  ...
  s.source       = { :git => "https://github.com/chenzhe555/HHZBaseClass.git", :tag => "#{s.version}" }
  ...
  s.subspec 'HHZBaseClass' do |one|
      ...
      one.subspec 'tableview' do |two|
        two.subspec 'cell' do |three|
          three.source_files = 'HHZBaseClass/classes/tableview/cell/*.{h,m}'
        end
